...
4. **Never log sensitive data** — No passwords, tokens, PII, or session IDs in logs. Use structured logging. For PHI/HIPAA compliance, the **Privacy Guardian** provides dedicated review.
