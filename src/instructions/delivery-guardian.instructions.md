...
**Trigger words:** "review deployment", "check pipeline", "setup monitoring", "define SLOs", "disaster recovery", "BCDR plan", "blue-green", "canary deployment", "chaos testing", "load testing", "observability", "alerting setup", "Prometheus", "Grafana"
